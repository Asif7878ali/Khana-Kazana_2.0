  ...
  return (
    <MainLayout>
      <div id="LandingPage">
        ...
        <section id="PopularCategories" className="py-16 bgWhite">
        ...
        <section id="SpecialOffer" className="py-16 bgRose1">
          <div className="OwnContainer mx-auto">
              ...
              <div className="md:w-1/2 mb-8 md:mb-0">
                ...
                <ul className="mb-8 textgray6">
                  <li className="flex items-center mb-2">
                    <span className="textRose mr-2">✓</span> 4{" "}
                    {translate("sort.mainCourses")}
                  </li>
                  <li className="flex items-center mb-2">
                    <span className="textRose mr-2">✓</span> 2{" "}
                    {translate("sort.sideDishes")}
                  </li>
                  <li className="flex items-center mb-2">
                    <span className="textRose mr-2">✓</span> 4{" "}
                    {translate("sort.desserts")}
                  </li>
                  <li className="flex items-center">
                    <span className="textRose mr-2">✓</span> 4{" "}
                    {translate("sort.beverages")}
                  </li>
                </ul>
        ...
        <section id="Testimonials" className="py-16 bgWhite">
          <div className="OwnContainer mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-2 textgray8">
        ...
        <section id="CalltoAction" className="py-16 bgRose1">
        ...
        <section id="Features" className="py-16 bgWhite">
          <div className="OwnContainer mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
